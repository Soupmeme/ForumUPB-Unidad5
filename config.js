...
export const config = {
  ...
  station: {
    ...
    bondsMax: 220,         // max bond LINE SEGMENTS a station's bonds buffer can hold (a curved bond uses several segments, not just one)
  },
  ...
  thread: {
    ...
    height: 2.0,           // center height of each coil axis above the floor line (low, but clear of the placard's swing)
